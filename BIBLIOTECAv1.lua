...
for i, opcion in ipairs(opciones) do
    ...
    local function ajustarTamañoScrollingFrame()

    local contenidoHeight = gridLayout.AbsoluteContentSize.Y

    scrollingFrame.CanvasSize = UDim2.new(0, 0, 0, contenidoHeight)
