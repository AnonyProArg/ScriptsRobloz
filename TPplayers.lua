...
local function CreateTeleportButton(player)
    ...
    TeleportButton.Position = UDim2.new(0.05, 0, 0, 10 + ((30 + 10) * (#ScrollFrame:GetChildren() - 1)))
...
local function UpdatePlayerList()
    ...
    -- Crear los nuevos botones de teletransporte

    local totalHeight = 10 -- Espacio superior

    local buttonHeight = 30 -- Altura de cada botón

    local spacing = 10 -- Espacio entre botones
    ...
    -- Ajustar la propiedad CanvasSize del cuadro de desplazamiento
